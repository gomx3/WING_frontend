...
export const StockDashboard = ({ graphId }: Props) => {
    ...
    return (
        <div
            className={`absolute top-4 right-4 p-4 w-[280px] bg-white border border-neutral-300 rounded-2xl z-30 flex flex-col shadow-2xl overflow-hidden transition-all duration-300 ease-in-out ${
